...
//const apiKey = '58e9634c43c04daaa1cd52796aa74f7aef'; //If that one doesn't work, try this one: e7d90402b4004aaeb8cec4e6da195607. This key currently worked. If the one ending in dd doesn't work, try this one again.
//const apiKey = 'N4V3NKK84ONUALBK';
//const apiToken = 'pk_ff7603d357ef45529330f9757e0b7ed7';
const apiKey = 'd4254f019amsh4409182db38e154p1cf8b7jsn9e16217755dd'; //New API Key I guess?
...
const API = {
  ...
  fetchMonthlyData: async () => {
    ...
    try {
      const response = await fetch(
        `https://twelve-data1.p.rapidapi.com/time_series?symbol=${stockTicker}&interval=${monthlyInterval}&outputsize=5000&format=json`,
        options
      );
      if (!response.ok) {
  ...
  prevDayCloseQuote: async () => {
    const url =
      `https://twelve-data1.p.rapidapi.com/quote?symbol=${stockTicker}&outputsize=30&format=json&interval=1day`;
    const options = {
      method: "GET",
      headers: {
        "x-rapidapi-key": apiKey,
